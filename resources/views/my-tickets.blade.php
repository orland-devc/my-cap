        ...
        <div id="postForm" class="max-w-full mx-auto sm:px-6 lg:px-8" style="width: 800px">
            <div class="bg-white overflow-hidden shadow-lg rounded-lg">
                <div class="p-6 text-gray-900 max-h-[80vh] overflow-y-auto scrollBars">
                    <h1 class="text-2xl font-semibold text-gray-700 mb-4">Create New Ticket2</h1>
                    ...
                    <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <label for="level" class="block text-gray-700 font-semibold mb-2">Urgency Level</label>
                                <div class="relative">
                                    <select id="ticketLevel" name="level" class="shadow appearance-none border rounded-lg w-full py-4 px-6 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200" required>
