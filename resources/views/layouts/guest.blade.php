...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased" style="background-image: url('/images/psuscschool.jpg'); background-size: cover; position: relative; background-repeat: no-repeat;">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 backdrop-blur-sm" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: #0008;">
