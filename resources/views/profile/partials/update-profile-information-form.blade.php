            ...
            <div class="mb-10">
                <div class="">
                    <div class="relative group">
                        <img id="profile-pic-preview" src="{{ asset($user->profile_picture) }}" alt="Profile Picture" class="w-40 h-40 rounded-full object-cover border-4 border-indigo-200 shadow-lg transition-all duration-300 group-hover:border-indigo-400">
                        ...
                        <div class="absolute inset-0 bg-black bg-opacity-50 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <label for="profile-picture" class="cursor-pointer p-4">
                                ...
                                <input type="file" id="profile-picture" name="profile_picture" class="hidden" onchange="previewProfilePicture(event)" accept="image/*">
                            </label>
                        </div>
                    </div>
                </div>
