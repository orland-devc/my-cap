...
<x-users-layout>
    <x-slot name="header">
        <a href="http://127.0.0.1:8000/my-tickets" class="absolute text-xl top-4 ml-2" style="transform:translateX(-100%)">
        ...
        <div>
            ...
            <span class="ml-5 mt-2 text-sm text-gray-700">{{ $ticket->created_at->format('M d, Y g:i A') }}</span>
        </div>
    </x-slot>
    ...
    <div class="max-w-screen flex p-3 bg-gray-100">
        <div class="bg-white border border-2 shadow-lg rounded-lg mr-2 w-1/4 min-w-72 border">
            ...
            <div class="py-4 px-6 overflow-y-auto ticket-content" style="max-height: ">
                <div class="mb-4">                    
