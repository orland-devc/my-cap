    ...
    <div class="container mx-auto p-4" x-data="chatbot()">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex">
                ...
                <button @click="sendMessage" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-2">Send</button>
            </div>
        </div>
    </div>
